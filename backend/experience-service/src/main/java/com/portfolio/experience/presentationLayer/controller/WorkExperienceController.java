...
public class WorkExperienceController {
    ...
    @PostMapping
    public ResponseEntity<WorkExperienceDTO> createExperience(@Valid @RequestBody WorkExperienceDTO workExperienceDTO) {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @PutMapping("/{id}")
    public ResponseEntity<WorkExperienceDTO> updateExperience(@PathVariable Long id, 
                                                               @Valid @RequestBody WorkExperienceDTO workExperienceDTO) {
        WorkExperienceDTO updatedExperience = workExperienceService.updateExperience(id, workExperienceDTO);
