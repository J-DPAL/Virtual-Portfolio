...
public class DataSeeder implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    Integer p = jdbc.queryForObject(checkProjectSql, new MapSqlParameterSource("title", "SmartCD.ai"), Integer.class);
    if (p == null) {
    ...
    Integer e = jdbc.queryForObject(checkExpSql, new MapSqlParameterSource().addValue("company", "Product Manager Accelerator").addValue("position", "Full-Stack AI Engineering Intern"), Integer.class);
    if (e == null) {
