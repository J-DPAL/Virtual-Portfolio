      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 bg-white rounded-2xl shadow-lg border border-slate-200 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Link
              to="/admin/settings"
              className="flex items-center justify-center px-6 py-4 rounded-xl border-2 border-slate-300 text-slate-700 font-semibold hover:border-purple-500 hover:text-purple-600 transition"
            >
              <svg
                className="w-5 h-5 mr-2"
                fill="none"
